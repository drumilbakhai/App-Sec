Hello. Application Security git repository.
...
For executing Assignment-2, please follow the same instruction mentioned above

Fixing all vulnerabilities from the Assignment-1